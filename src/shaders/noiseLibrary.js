 ...
 *
 * Collection of noise functions for use in WebGL shaders.
 * Each noise type includes the complete GLSL code for the noiseFunction() implementation.
 */

export const noiseShaderLibrary = {
  simplex: /* glsl */`
    vec3 mod289(vec3 x) {
